...
const (
	...
	BookService_GetAllBook_FullMethodName = "/pb.BookService/GetAllBook"
	BookService_SearchBook_FullMethodName = "/pb.BookService/SearchBook"
)
...
func (c *bookServiceClient) SearchBook(ctx context.Context, in *SearchBookRequest, opts ...grpc.CallOption) (*SearchBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookService_SearchBook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BookService_SearchBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_SearchBook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
